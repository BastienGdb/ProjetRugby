    ...
    public class StubDataManager : IDataManager
    {
        ...
        public IEnumerable<Competition> ChargeCompetition()
        {
            return new List<Competition>
            {
                ...
                new CompetitionAPoule("Coupe du monde", TypeEquipe.Club, "Coupe du monde","Images/wordcup.png"),
        ...
        public IEnumerable<Match> ChargeMatchs()
        {
            return new List<Match>
            {
                ...
                new Equipe("La Rochelle",TypeEquipe.Club,"Club de rugby de la ville de La Rochelle","/Images/logotop14/laRochelle.png"),26,
                new CompetitionPouleUnique("Championnat français", TypeEquipe.Club, "ProD2","Images/ProD2.png"),52,8,9,2),
            };
        }
        ...
        public IEnumerable<CompetitionPouleUnique> ChargeChampionsCup()
        {
            ...
            {
                new CompetitionPouleUnique("poule 1 de la champions Cup", TypeEquipe.Club,"Poule 1","/Images/logoCompet/ChampionsCup.png"),
                new CompetitionPouleUnique("poule 2 de la champions Cup", TypeEquipe.Club,"Poule 2","/Images/logoCompet/ChampionsCup.png"),
                new CompetitionPouleUnique("poule 3 de la champions Cup", TypeEquipe.Club,"Poule 3","/Images/logoCompet/ChampionsCup.png"),
                new CompetitionPouleUnique("poule 4 de la champions Cup", TypeEquipe.Club,"Poule 4","/Images/logoCompet/ChampionsCup.png"),
                new CompetitionPouleUnique("poule 5 de la champions Cup", TypeEquipe.Club,"Poule 5","/Images/logoCompet/ChampionsCup.png"),
            };
        }
        ...
        public IEnumerable<CompetitionPouleUnique> ChargeChallengeCup()
        {
            return new List<CompetitionPouleUnique>
            {
                new CompetitionPouleUnique("poule 1 de la challenge Cup", TypeEquipe.Club,"Poule 1","/Images/logoCompet/ChallengeCup.png"),
                new CompetitionPouleUnique("poule 2 de la challenge Cup", TypeEquipe.Club,"Poule 2","/Images/logoCompet/ChallengeCup.png"),
                new CompetitionPouleUnique("poule 3 de la challenge Cup", TypeEquipe.Club,"Poule 3","/Images/logoCompet/ChallengeCup.png"),
                new CompetitionPouleUnique("poule 4 de la challenge Cup", TypeEquipe.Club,"Poule 4","/Images/logoCompet/ChallengeCup.png"),
                new CompetitionPouleUnique("poule 5 de la challenge Cup", TypeEquipe.Club,"Poule 5","/Images/logoCompet/ChallengeCup.png"),
            };
        }
